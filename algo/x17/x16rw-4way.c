...
{
   cubehashInit( &x16rw_4way_ctx.cube, 512, 16, 32 );
};


void x16rw_4way_hash( void* output, const void* input )
{
...
//   uint32_t inp3[24] __attribute__ ((aligned (64)));
   ...
   if ( s_ntime == UINT32_MAX )
   {
      ...
      x16_rw_s_getAlgoString( &tmp[4], hashOrder );
   }
